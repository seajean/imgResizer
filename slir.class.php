 ...
 * text" /></code>
 *http://localhost/slir/w100-h100-c1x1-q100/images/IMG_8304.JPG
...
class SLIR
{
	...
	{
		$md5 = $this->renderedCacheFilename();
		//echo "renderedCacheFilePath()::".$md5.'<br>';
		return $this->getRenderedCacheDir() . $md5;
	}
	...
	{
		//echo 'md5::::' . serialize($this->rendered->cacheParameters())."<br>";
	...
	{
		//echo $this->renderedCacheFilePath();
